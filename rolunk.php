<?php include 'header.php' ?>
    <div class="container-rolunk">
        ...
        <div class="about-container">
            ...
            <img src="./img/kopi.jpg" alt="" srcset="" width="200px" height="200px"> <!--Bal-->
            <p><b>A csapat bolondja, szereti lógatni a lábát, és semmittenni. Leginkább a ctrl-c ctrl-v hez ért.</b></p>
        </div>

        <h2>Adrián</h2>
        <div class="about-container">
            <img src="./img/adrian.jpg" alt="" srcset="" width="200px" height="200px"> <!--Jobb-->
            <p><b>A csapat agya, mindent is tud. Leginkább a css-hez ért.</b></p>
        </div>
        
        <h2>Ricsko</h2>
        <div class="about-container">
            <img src="./img//ricsko.jpg" alt="" srcset="" width="200px" height="200px"> <!--Bal-->
